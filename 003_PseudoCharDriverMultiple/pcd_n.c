...
/* Initialization of File operation data structure */
...
/* Initialization of Driver private data structure */
...
MODULE_DESCRIPTION("A pseudo character driver that handles n devices.");
